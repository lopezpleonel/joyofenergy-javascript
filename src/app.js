...
const { lastWeekConsumption } = require("./consumptions/consumption-controller");
...
app.get("/consumption/last-week/:smartMeterId", (req, res) => {
    res.send(lastWeekConsumption(getReadings, req));
});
